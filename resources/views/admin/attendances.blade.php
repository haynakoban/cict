...
<form id="my-form" action="/admin/attendances" method="GET">
    @csrf
...
@foreach ($attendances as $attendance)
    ...
    <li>{{ $attendance->start_time }}</li>
    <li>{{ $attendance->schedule_status }}</li>
    <li>{{ $attendance->semester }}</li>
    <li><a href="/admin/attendances/{{ $attendance->schedule_id }}">Comment</a></li>
    <hr>
@endforeach
